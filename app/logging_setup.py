    ...
    if sys.platform == 'win32':
        try:
            ...
            if not console_window:
                ...
                sys.stdout = io.TextIOWrapper(open('CONOUT$', 'w', encoding='utf-8', buffering=1), encoding='utf-8', write_through=True)
                sys.stderr = io.TextIOWrapper(open('CONOUT$', 'w', encoding='utf-8', buffering=1), encoding='utf-8', write_through=True)
            else:
