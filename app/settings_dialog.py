...
class SettingsWindow(QWidget):
    ...
    def init_ui(self):
        ...
        for checkbox in (
            self.show_friends_list_check,
            self.show_avatar_search_check,
            self.show_player_list_check,
            self.show_account_info_check,
            self.show_chatbox_preview_check,
            self.show_preset_config_check,
        ):
        ...
        self.avatar_provider_combo.setToolTip(
            'VRCX-style search APIs. Retries alternate HTTPS ports when the default fails.'
        )
    ...
    def test_avatar_apis(self) -> None:
        self.avatar_api_status.setText('Testing avatar APIs from this PC...')
